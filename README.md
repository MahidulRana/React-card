...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=17395348&assignment_repo_type=AssignmentRepo)
...
<h1 align="center">Name of the group (TEAMMBLCP) </h1>
<p align="center">
    <strong> Here are our group members with matriculation </strong>
    <br>
   Md Zahid Hasan (1396470) <br>
   Samsil Arefin (1393091) <br>
   Niloy Sarker (1345719) <br>
   Mahidul Islam Rana (1502217) <br>
</p>
<br/>

## Project Description
Understanding fundamental design principles of the project with implementing 5G CoreNetwork(s), including Radio Access Networks (RANs), User Equipment (UEs), Data Networks (DNs), Network Slicing, Management and Orchestration.
